...
class MainUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        global names
        with open("D:\\HocTap\\New folder\\app\\FaceRecognition-GUI-APP\\nameslist.txt", "r") as f:
            x = f.read()
            z = x.rstrip().split(" ")
            for i in z:
                names.add(i)
    ...
    def on_closing(self):
        ...
        if messagebox.askokcancel("Quit", "Are you sure?"):
            global names
            f =  open("D:\\HocTap\\New folder\\app\\FaceRecognition-GUI-APP\\nameslist.txt", "a+")
            for i in names:
                    f.write(i+" ")
            self.destroy()
...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            render = PhotoImage(file='D:\\HocTap\\New folder\\app\\FaceRecognition-GUI-APP\\homepagepic.png')
...
app = MainUI()
app.iconphoto(False, tk.PhotoImage(file='D:\\HocTap\\New folder\\app\\FaceRecognition-GUI-APP\\icon.ico'))
app.mainloop()
